...
class FilmsServiceTest {
    ...
    void shouldReturnMovieDuration() {
        ...
        String result =
                filmsService.getMovieDuration("Interstellar");
    ...
    void shouldReturnPosterUrl() {
        ...
        String result =
                filmsService.getFilmUrl("Batman");
    ...
    void shouldReturnWatchedFilms() {
        ...
        List<Films> result =
                filmsService.getWatchedFilms(123L);
    ...
    void shouldReturnPopularFilms() throws IOException, InterruptedException {
        ...
        List<Films> result =
                filmsService.getPopularFilmsThisWeek();
